        ...
        patternStream
                .flatSelect(new PatternFlatSelectFunction<Tuple3<String, String, Long>, String>() {
                    ...
                    public void flatSelect(Map<String, List<Tuple3<String, String, Long>>> pattern, Collector<String> out) throws Exception {
                        ...
                        //second => [Event]
                        //third => [Event]
                        Tuple3<String, String, Long> first = pattern.get("first").get(0);
                        Tuple3<String, String, Long> second = pattern.get("second").get(0);
                        Tuple3<String, String, Long> third = pattern.get("third").get(0);
